    ...
    "items": [
      {
        ...
        "answer": [
          "Start by adding yourself first! When you create a tree and add yourself as the first person, you automatically become the 'Main Person' that the tree centers around. From there, add your closest relatives: your parents, siblings, spouse/partner, and children. This creates the core structure of your tree, and you can branch out from there to grandparents, aunts, uncles, and cousins."
        ]
      },
      {
        "question": "What is the 'Main Person' in my tree?",
        "answer": [
          "The Main Person is who the tree focuses on by default when you or anyone else opens it. The first person you add becomes the Main Person automatically. You can change this anytime by clicking on any family member and tapping 'Set as Main'. This is helpful if you're building a tree centered around a grandparent or another relative."
        ]
      },
      {
        "question": "What order should I add family members?",
        "answer": [
          "We recommend this order: 1) Add yourself first, 2) Add your parents, 3) Add your siblings, 4) Add your spouse/partner and children, 5) Add grandparents, 6) Branch out to aunts, uncles, and cousins. This builds a strong foundation and makes it easier to add relationships correctly."
        ]
      },
      {
        "question": "How do I add relationships between family members?",
        "answer": [
          "After adding family members, click on any person in the tree, then tap 'Add Relationship'. Choose the relationship type (Parent, Child, Spouse, or Sibling) and select the other person. For example, to connect yourself to your mother: click on yourself, add relationship, select 'Parent', and choose your mother."
        ]
      },
      {
        "question": "Can I view the tree from a different person's perspective?",
        "answer": [
          "Yes! Click on any family member in the tree and tap 'Set as Focus'. The tree will recenter to show that person's connections. This is temporary - the tree will return to the Main Person next time you open it. To permanently change the center point, use 'Set as Main' instead."
        ]
      },
      {
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answer": [
          "Absolutely, and many families do. Use Ancestry or FamilySearch for researching ancestors and historical records. Use FamilyRoots to manage the living side of your family: collaboration, privacy, profile ownership, event tracking, gift registries, and staying connected. FamilyRoots already integrates with FamilySearch — you can search historical records and import entire family branches directly from FamilyRoots without switching platforms."
        ]
      },
      {
        ...
        "answer": [
          ...
          " for a complete side-by-side feature matrix covering Tree Building, Collaboration, Privacy & Security, Connections, AI & Technology, and Pricing. You can also click 'Compare to Ancestry' from our ",
          {
            "text": "home page",
            "href": "/"
          },
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "answer": [
          "We support eight tree types, each with its own built-in relationship structure:",
          {
            "tag": "ul",
            "className": "list-disc pl-5 mt-2 space-y-2 text-sm",
            "children": [
              {
                "tag": "li",
                "children": [
                  ...
                  " — Parent/Child, Spouse/Partner, Sibling, Co-Parent. Qualifiers: Biological, Step, Adopted, Foster, Half, In-Law."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Pastor/Leader, Elder/Deacon, Ministry Leader/Member, Teacher/Student, Worship Leader, Volunteer, Mentor/Mentee. Tags: Youth Ministry, Worship Team, Sunday School, Bible Study, Choir, Outreach."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Head Coach/Player, Assistant Coach, Captain, Player, Trainer/Physio, Manager/Staff, Teammate, Alumni. Tags: Starter, Reserve, Varsity, JV, Injured Reserve, Retired."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Big/Little (mentor pairs), Pledge Class, Chapter President, Officer, Faculty Advisor, Active Member, Alumni. Tags: Class of 2024–2030, Active, Pledge, Honorary."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Best Friend, Close Friend, Friend, Roommate, Neighbor, Acquaintance. Tags: School, Work, Neighborhood, Online, Childhood, Mutual Friends."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Manager/Direct Report, Colleague, Mentor/Mentee, Client, Business Partner, Intern/Supervisor. Tags: Engineering, Design, Marketing, Sales, Finance, HR, Executive."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — Teacher/Student, Principal, Dean, Counselor, Classmate, Tutor/Tutee, Club Advisor, Team Captain, Lab Partner. Tags: Freshman, Sophomore, Junior, Senior, Graduate, Faculty, Staff, Honor Roll."
                ]
              },
              {
                "tag": "li",
                "children": [
                  ...
                  " — The catch-all. Starts with Leader, Co-Leader, Member, Teacher/Student, Mentor/Mentee, Connected. But you can replace or add any roles you need. Perfect for book clubs, bands, study groups, neighborhood watches, or anything else that doesn't fit the above."
                ]
              }
            ]
          },
          {
            ...
            "children": [
              "Every type also lets you add your own custom roles on top of the defaults during creation."
            ]
          }
        ]
      },
    ...
    "items": [
      {
        ...
        "answer": [
          "Your first 20 family members are completely free, no credit card needed. After that, you purchase member packs: Starter (10 credits for $7.99), Growth (25 credits for $14.99), or Family (50 credits for $24.99). Each credit lets you add one family member. Credits never expire, so you only buy when you're ready to grow. See our ",
          {
            "text": "Pricing page",
            "href": "/pricing"
          },
      ...
      },
      {
        ...
        "answer": [
          "No. Credits never expire. Once you purchase a member pack, those credits are yours to use whenever you want. There's no monthly deadline, no use-it-or-lose-it pressure. Add members at your own pace."
        ]
      },
      {
        "question": "How do activity rewards work?",
        "answer": [
          "We reward families who are actively building their trees. Add 5 or more family members in a single month and you'll get 20% off your next member pack purchase. Reach the milestone of 100 total members and you'll receive a free Starter Pack (10 credits) as a thank-you for your dedication to preserving your family history."
        ]
      },
      {
        "question": "Do credits apply across all my trees?",
        "answer": [
          "Yes. Your credit balance is tied to your account, not a specific tree. You can create unlimited trees for free and use your credits to add members to any of them. Your total member count across all trees determines when your 20 free slots are used up."
        ]
      },
      {
        "question": "What are the FamilyRoots plans, and do I need a paid one?",
        "answer": [
          "Explorer is free. The optional paid plans are Cultivator at $4.99/month, Heritage at $12.99/month, and Legacy at $24.99/month. Paid plans provide progressively higher limits for features such as AI Chat, FamilySearch imports, group email, AI video, media uploads, and voice or video uploads. Core tree-building features remain available on Explorer. See our ",
          {
            "text": "Pricing page",
            "href": "/pricing"
          },
          " for the current limits included with each plan."
        ]
      },
      {
        "question": "What happens to my data if I stop buying credits?",
        "answer": [
          "Nothing changes. Your trees, members, relationships, photos, and everything you've built stays exactly as it is. You just won't be able to add new members beyond your free slots until you purchase more credits. Your family can still view, collaborate on, and interact with existing trees."
        ]
      },
      {
        "question": "Can I cancel a paid plan anytime?",
        "answer": [
          "Yes. You can cancel your subscription at any time and you'll keep access through the end of your billing period. After that, you'll lose access to paid features like voice notes, video attachments, and expanded upload limits, but all your trees, members, and data remain intact. Existing voice notes and videos you've already uploaded stay accessible."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "You can add relationships between any family members without requiring a marriage connection. Simply: 1) Add the other parent as a new family member, 2) Click on that person in the tree, 3) Click 'Add Relationship', 4) Select 'Parent' and choose your child. This creates a parent-child connection without implying any relationship between the parents. Parents of a common child are connected through their individual parent-child relationships, not through a spouse relationship."
        ]
      },
      {
        "question": "How do I edit or delete a relationship?",
        "answer": [
          "Click on any family member to open their details panel, then scroll down to the 'Family Relationships' section. Each relationship shows edit (pencil) and delete (trash) buttons. Click the pencil to change the relationship type (parent, spouse, or sibling), or click the trash to remove the relationship entirely. This gives you full control to fix any mistakes or update your family connections."
        ]
      },
      {
        "question": "Can I invite family members who don't have an account yet?",
        "answer": [
          "Yes! When you add a family member and include their email address, they'll receive an invitation to join FamilyRoots. Once they create an account, they can view and contribute to the shared family tree based on the permissions you've set."
        ]
      },
      {
        "question": "How do I connect two separate family trees?",
        "answer": [
          "Use our Tree Connections feature. When you discover that a member in your tree also appears in another family's tree (through Smart Matching or manually), you can request to connect the trees. Once both tree owners approve, the trees are linked and you can see how the families connect."
        ]
      },
      {
        "question": "What is the Merged Tree View?",
        "answer": [
          "The Merged Tree View combines your family tree with any trees you're connected to, showing them as one unified visualization. Toggle 'Show Connected Trees' in your tree view to see your extended family across multiple trees. This is perfect for seeing how your family connects to your spouse's family or other branches."
        ]
      },
      {
    ...
    "items": [
      {
        ...
        "answer": [
          ...
          ", click the 'Share' button on your tree and create an invitation link. You can set permission levels: Viewer (can only view), Editor (can add and edit members), or Co-owner (full access including sharing). You can also set expiration dates and usage limits on invitation links."
        ]
      },
      {
        "question": "What are the different permission levels for collaborators?",
        "answer": [
          "There are three permission levels: Viewers can see the tree and all member details but cannot make changes. Editors can add new members, edit existing ones, and create relationships. Co-owners have full access including the ability to invite others, manage collaborators, and delete the tree."
        ]
      },
      {
        "question": "Can I remove someone's access to my tree?",
        "answer": [
          "Yes, as the tree owner or co-owner, you can remove any collaborator's access at any time. Go to your tree settings and manage collaborators to revoke access."
        ]
      },
      {
    ...
    "items": [
      {
        ...
        "answer": [
          "Profile claiming lets you take ownership of your own entry in a family tree. Once you claim your profile, you can update your own personal information (name, photo, bio, dates) directly, without needing to ask the tree owner to make changes for you. It's a way to keep your own information accurate and up-to-date."
        ]
      },
      {
        "question": "How do I claim my profile in a family tree?",
        "answer": [
          "Open the family tree where you appear, click on your entry to view the member details, and look for the 'Claim This Profile' button. Submit a request with an optional message explaining who you are. The tree owner will review and approve your request."
        ]
      },
      {
        "question": "What happens after I claim my profile?",
        "answer": [
          "Once approved, you'll have edit access to your own personal details in that tree - things like your name, photo, bio, birth date, and contact information. You won't be able to add or remove family members or change relationships - that stays with the tree owner and editors."
        ]
      },
      {
        "question": "Can I claim someone else's profile?",
        "answer": [
          "No, you can only claim your own profile. Only living family members can claim profiles, and each person can only claim one profile. The tree owner reviews all claim requests to verify they're legitimate before approving."
        ]
      },
      {
        "question": "What if my claim is denied?",
        "answer": [
          "If a tree owner denies your claim, you'll see the status update in the member profile. The owner may include a reason for the denial. You can reach out to the tree owner directly to discuss or clarify your identity."
        ]
      },
      {
        "question": "As a tree owner, how do I manage profile claims?",
        "answer": [
          "You'll see pending claims on your ",
          {
            "text": "Dashboard",
            "href": "/dashboard"
          },
          ". Review each request - you can see who's asking to claim which profile and any message they included. Approve legitimate claims so family members can manage their own information, or deny requests that seem incorrect or suspicious."
        ]
      },
      {
        "question": "If I claim my profile in one tree, does it apply to other trees?",
        "answer": [
          "Profile claims are per-tree, so you do need to claim your profile in each tree separately. However, FamilyRoots has a smart sync built in: when you claim a profile and you already have a claimed profile in another tree, the system automatically detects this and opens a merge dialog. You can review both profiles side-by-side, resolve any differences (like different names, birth dates, or emails), and sync the resolved data to both profiles. After syncing, the merged view will show you as one person across both trees, while your relationships in each tree stay intact."
        ]
      },
      {
        "question": "What are Potential Family Connections?",
        "answer": [
          "When you connect two trees, FamilyRoots automatically scans for members who appear in both trees — the same person listed under different entries. These appear as 'Potential Family Connections' on your Dashboard with a match confidence score. If you own both trees, clicking 'Connect' instantly opens a merge dialog where you can resolve any field differences (name, birth year, etc.) and sync both profiles. The system matches by name, birth year, birth place, and gender to catch duplicates even when the details differ slightly."
        ]
      },
      {
        "question": "What happens when I merge two profiles across different trees?",
        "answer": [
          "Cross-tree merging is a sync, not a deletion. Both members stay in their respective trees so all their relationships are preserved. The resolved field values (the ones you pick in the merge dialog) are applied to both profiles, and both get linked to your account. The merged view then automatically shows them as one person. Any linked data like life events, education, and career records are also copied to the primary profile so nothing is lost."
        ]
      },
      {
        "question": "What is profile custodianship for deceased family members?",
        "answer": [
          "When a family member passes away, their profile may need ongoing management. Custodianship allows a direct relative (parent, child, spouse, or sibling) to request permission to manage that person's profile - updating death dates, memorial information, and keeping their legacy accurate."
        ]
      },
      {
        "question": "How do I request custodianship of a deceased relative's profile?",
        "answer": [
          "Open the profile of the deceased family member and look for the 'Request Custodianship' button. Select your relationship to them and explain why you'd like to be their custodian. The tree owner has 30 days to approve or deny your request."
        ]
      },
      {
        "question": "What happens if the tree owner doesn't respond to my custodianship request?",
        "answer": [
          "If the tree owner takes no action within 30 days, your custodianship request is automatically approved. They'll receive reminder emails at regular intervals, but this 'right of first refusal' window ensures profiles aren't left unmanaged indefinitely."
        ]
      },
      {
        "question": "What can a profile custodian edit?",
        "answer": [
          "As a custodian, you can update the deceased member's death date, memorial information, biography, and basic profile details. You cannot add or remove family relationships or change the family tree structure - that remains with the tree owner."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "Life events are important moments in a family member's life - births, deaths, marriages, divorces, graduations, achievements, and other milestones. To record one, click on a family member's profile and look for the 'Life Events' section. Add the event type, date, description, and even attach photos or videos."
        ]
      },
      {
        "question": "Can I attach photos and videos to life events?",
        "answer": [
          "Yes! Each life event can have multiple photo and video attachments. Photos (up to 10MB each) are available on all tiers. Video and audio attachments (up to 100MB each) require a Cultivator subscription or above. This is a great way to preserve memories alongside the historical record - wedding photos, graduation pictures, and other cherished moments."
        ]
      },
      {
        ...
        "answer": [
          ...
          " and find the 'Notification Preferences' section. Enable email notifications, then choose which event types you want to receive updates about - births, deaths, marriages, divorces, or milestones. All notifications are opt-in, so you only receive what you want."
        ]
      },
      {
        "question": "Who can see the life events I record?",
        "answer": [
          "Life events are visible to everyone who has access to the family tree where the event was recorded. If you're a collaborator with view-only access, you can see events but not create new ones. Editors and tree owners can add and manage events."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "By default, your family trees are private and only visible to you. You control exactly who has access by sending invitation links. You can also make trees 'Unlisted' (viewable by anyone with the link) or keep them strictly private."
        ]
      },
      {
        "question": "Is my family's information secure?",
        "answer": [
          "Yes, we take security seriously. All data is encrypted in transit and at rest. We use secure authentication through Replit Auth, and your data is stored on secure, backed-up servers. We never sell your family information to third parties."
        ]
      },
      {
        "question": "What is Smart Matching and is my data shared with others?",
        "answer": [
          "Smart Matching helps you discover when someone in your tree might also appear in another user's tree. It's completely opt-in - you choose which members can be matched and which data points (name, email, birthdate) are used for matching. No personal data is shared until both parties approve a connection."
        ]
      },
      {
        "question": "How do I make a family member discoverable for Smart Matching?",
        "answer": [
          "Open the member's profile and look for the 'Family Matching' section. Toggle 'Make discoverable' to on, then select which information can be used for matching. You control whether others can find matches using the member's email, name, birthdate, or birthplace."
        ]
      },
      {
        "question": "What are the privacy visibility tiers and how do they work?",
        "answer": [
          "Privacy visibility tiers control how much information is visible to different family members. There are three tiers: 'Full Access' shows everything (dates, locations, photos, notes, life events), 'Extended Family View' shows only name, birth year, relationship, and photo, and 'Limited' shows just name and relationship. Immediate family (parents, children, spouse, siblings) always have full access regardless of the tier setting."
        ]
      },
      {
        ...
        "answer": [
          ...
          " and click the three dots menu on any tree you own. Select 'Privacy Settings' to choose the default visibility tier. This setting affects how much information non-immediate family members can see about people in your tree."
        ]
      },
      {
        "question": "Can I set different privacy levels for specific family members?",
        "answer": [
          "Yes! Tree owners and people who have claimed their own profiles can set visibility overrides on individual members. When editing a family member, look for the 'Privacy Visibility Override' option. This lets you make specific members more or less visible than the tree's default."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "The Deadman Switch ensures your family trees aren't lost if something happens to you. You can designate an heir who will inherit your trees after a period of inactivity (6-24 months, you choose). Configure this in your ",
          {
            "text": "Account Settings",
            "href": "/account/settings"
          },
          ". If you become inactive, you'll receive a reminder email with 30 days to respond. If there's no response, ownership transfers to your designated heir."
        ]
      },
      {
        "question": "How does the Relationship Calculator work?",
        "answer": [
          "Click on any family member, then set another member as your 'Focus'. The relationship calculator automatically determines how the two people are related - whether they're first cousins, great-aunts, second cousins once removed, or any other relationship. It traces the path through your family tree."
        ]
      },
      {
        "question": "How do I know when a family member's birthday is coming up?",
        "answer": [
          "FamilyRoots shows small badge indicators directly on member cards in the tree visualization. If someone has a birthday within the next 30 days, you'll see a birthday cake icon with a countdown. Members with active gift registries show a purple gift icon. These indicators appear automatically — no setup needed beyond adding birth dates. You can also check the Registries tab in your tree view to see all active gift registries at a glance, and the Timeline tab shows all upcoming and past events in chronological order."
        ]
      },
      {
        "question": "Can I see my family timeline?",
        "answer": [
          "Yes! Each tree has a Timeline tab that automatically gathers every dated event into one chronological view. This includes birth dates and death dates from member profiles, plus all life events you've recorded — marriages, graduations, baptisms, career milestones, and more. Each event shows the member's photo, date, location, and event type with a color-coded icon. Events are grouped by year so you can see your family's history unfold decade by decade."
        ]
      },
      {
      ...
      },
      {
        ...
        "answer": [
          "Special Connections let you add non-blood relationships to your family tree, like godparents, best friends, mentors, significant others (boyfriend/girlfriend/fiance), and family friends. These connections show up on each person's profile and help capture the complete picture of who's important in your family's life."
        ]
      },
      {
        "question": "How do I add a godparent, best friend, or boyfriend/girlfriend?",
        "answer": [
          "Open the family member's profile by clicking on them in the tree, then scroll down to 'Special Connections'. Click 'Add' and choose the connection type (godparent, best friend, mentor, boyfriend, girlfriend, etc.), then select the person you want to connect them to. Both sides will see the connection."
        ]
      },
      {
        "question": "Can I connect with people in other family trees?",
        "answer": [
          "Yes! You can send connection requests to people in other family trees. They'll receive a notification and can approve or decline the request. Once approved, both trees can see the connection. This is great for connecting family friends across different families."
        ]
      },
      {
        "question": "How does location sharing work?",
        "answer": [
          "You can optionally add your current city, state/province, and country to your profile. If you enable 'Share location with connections', family members can find you when they're traveling to your area. This is completely optional - only share if you want to be discoverable."
        ]
      },
      {
        ...
        "answer": [
          ...
          " and search by city, state, or country. You'll see family members who have chosen to share their location. This makes it easy to meet up with relatives when you're traveling."
        ]
      },
      {
      ...
      },
      {
        ...
        "answer": [
          "Installing FamilyRoots as a mobile app gives you: faster loading times with offline caching, a full-screen experience without browser bars, easy access from your home screen, and push notification support. It's completely free and takes just seconds to install - no app store required!"
        ]
      },
      {
        ...
        "answer": [
          ...
          " to get a QR code that links directly to FamilyRoots. Family members can scan the code with their phone camera to instantly open the app. You can also copy the link, download the QR code as an image, or use your device's native share feature to send via text, email, or social media."
        ]
      },
      {
        ...
        "answer": [
          ...
          " and you'll see a scannable QR code. You can: 1) Show it to family members to scan with their phone, 2) Click 'Download QR Code' to save it as an image for printing or sharing, 3) Click 'Copy Link' to paste the URL in messages, or 4) Use the 'Share' button to send via your phone's share menu. The QR code is perfect for family reunions, printed invitations, or holiday cards!"
        ]
      },
      {
        "question": "What is Personal Profile QR Code sharing?",
        "answer": [
          "Personal Profile QR Codes are a game-changer for family reunions! Each family member has their own unique QR code that links to their profile. Visit ",
          {
            "text": "My QR Code",
            "href": "/my-qr"
          },
          " to get yours. When you meet relatives face-to-face, they simply scan your code with their phone camera to instantly see your profile and send a connection request. This makes building your family tree a team effort where everyone contributes!"
        ]
      },
      {
        "question": "How can QR codes help at family reunions?",
        "answer": [
          "At family reunions, personal QR codes transform how you connect! Instead of exchanging phone numbers or email addresses, family members can scan each other's QR codes to instantly connect on FamilyRoots. Print your QR code on name tags, display it on your phone, or include it on reunion materials. This way, everyone can do their part - each person adds their own branch to the tree, making the process faster and more collaborative. Get your code at ",
          {
            "text": "My QR Code",
            "href": "/my-qr"
          },
      ...
      },
      {
        ...
        "answer": [
          "When you scan someone's personal QR code, you'll see their FamilyRoots profile with their name, photo, and how many family trees they're building. If you're logged in, you can send a connection request with one tap. Once they accept, you can collaborate on trees together, see shared family members, and stay connected. It's the fastest way to grow your family network!"
        ]
      },
      {
        "question": "What is the Membership Badge?",
        "answer": [
          "Your Membership Badge is a personalized digital card that shows your FamilyRoots stats — how many trees you belong to, your total connections, your activity level, and more. It's a fun way to see your impact and share it with others. Find yours at ",
          {
            "text": "My Badge",
            "href": "/membership-badge"
          },
      ...
      },
      {
        ...
        "answer": [
          "Every user gets a unique referral code. Share it with friends and family — when they sign up using your code, both of you benefit. You can track how many people you've referred and see your referral stats in your Account Settings. It's a great way to grow your family network and help others discover FamilyRoots."
        ]
      },
      {
        "question": "Can I mute specific members or branches in my tree?",
        "answer": [
          "Yes. If you'd prefer not to see a particular member or an entire branch in your tree view, you can mute them. Muting hides them from your personal view without deleting them or affecting anyone else's view of the tree. Click on a member and look for the 'Mute' option. Muted members can be un-muted at any time."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "These are two different features! 'Print My Tree on Products' (on the ",
          {
            "text": "Merchandise page",
            "href": "/merchandise"
          },
          ") lets you print YOUR actual family tree on custom products like mugs, t-shirts, and posters - we handle everything from printing to shipping. 'Browse Gift Ideas' (on the ",
          {
            "text": "Gifts page",
            "href": "/gifts"
          },
          ") shows curated family tree-related products from Amazon - these are pre-made items that don't include your specific family tree. If you want your own tree printed, use the Merchandise page."
        ]
      },
      {
        "question": "Can I put my family tree on a mug, t-shirt, or poster?",
        "answer": [
          "Yes! You can export your family tree as a high-quality image and then order custom merchandise directly through our site. Choose from mugs, t-shirts, posters, and more. Your tree is printed on the product and shipped directly to you - all without leaving FamilyRoots."
        ]
      },
      {
        "question": "How does the merchandise ordering work?",
        "answer": [
          "It's simple: 1) Go to the Merchandise page, 2) Choose a product (mug, shirt, poster, etc.), 3) Click Customize and select your tree, 4) Preview how your tree looks on the item, 5) Checkout securely with your card. We handle production and shipping through our print partner. Tip: For the best experience previewing and customizing your tree on products, we recommend using a desktop or tablet - the preview is easier to see on a larger screen."
        ]
      },
      {
        "question": "What products can I put my family tree on?",
        "answer": [
          "We offer a variety of products including ceramic mugs, t-shirts in various sizes, hoodies, posters, canvas prints, and more. Each product shows a live preview of your tree before you order, so you know exactly what you're getting."
        ]
      },
      {
        "question": "How long does merchandise take to arrive?",
        "answer": [
          "Most orders are printed and shipped within 2-5 business days. Delivery time depends on your location - typically 5-10 business days for US addresses. You'll receive tracking information via email once your order ships."
        ]
      },
      {
        "question": "Can I download my family tree as an image?",
        "answer": [
          "Absolutely! You can export your family tree as a high-resolution PNG image at any time. This is great for printing at home, sharing digitally, or using in your own creative projects. Look for the 'Export' button when viewing your tree."
        ]
      },
      {
        "question": "Are the products good quality?",
        "answer": [
          "Yes! We partner with a professional print-on-demand service that uses high-quality materials and printing techniques. Products are made to order, ensuring fresh production and no excess inventory waste."
        ]
      },
      {
        "question": "Can I order merchandise as a gift for family members?",
        "answer": [
          "Definitely! Family tree merchandise makes wonderful gifts for reunions, holidays, or special occasions. During checkout, you can ship to any address - perfect for surprising relatives with a personalized family keepsake."
        ]
      },
      {
        "question": "What are Gift Registries?",
        "answer": [
          "Gift Registries let you create wishlists for family events like birthdays, baby showers, weddings, graduations, and more. You can add items from any online store — we support Amazon, Etsy, Giftlab, Giftory, and Lucasgift with built-in affiliate links, plus any other retailer URL. Family members can see what's needed and mark items as purchased to avoid duplicates. Everyone in the tree can browse all active registries from the Registries tab."
        ]
      },
      {
        "question": "How do I create a Gift Registry?",
        "answer": [
          "Click on any member in your tree to open their profile panel, then scroll to the 'Gift Registries' section. Create a registry for any occasion — birthdays, weddings, baby showers, holidays. To add items: type what you're looking for in the search box, click a store button (Amazon, Etsy, Giftlab, Giftory, or Lucasgift) to search on that retailer's site, find the item you want, copy the product link from your browser, then paste it back into the registry. The link is saved automatically — just fill in the item name, price, and quantity. Once created, the registry appears on the member's profile, on their tree card badge (purple gift icon), and in the tree-wide Registries tab so the whole family can find it."
        ]
      },
      {
      ...
      },
      {
        ...
        "answer": [
          "Yes! Any family member with access to the tree can mark registry items as purchased. This prevents duplicate gifts and shows real-time progress on how many items have been fulfilled. Perfect for coordinating gifts across the whole family."
        ]
      },
      {
        "question": "What payment methods do you accept?",
        "answer": [
          "We accept all major credit and debit cards (Visa, Mastercard, American Express, Discover) as well as cryptocurrency including Bitcoin, Ethereum, and stablecoins like USDC. All payments are processed securely through Stripe."
        ]
      },
      {
        "question": "How do crypto payments work?",
        "answer": [
          "When you checkout, you can choose to pay with cryptocurrency. Simply select the crypto option, connect your wallet (like MetaMask), and complete the payment. The crypto is instantly converted to USD - you don't need to worry about price changes. Your order is processed exactly the same as a credit card payment."
        ]
      },
      {
        "question": "If I pay with crypto, do you receive crypto or dollars?",
        "answer": [
          "We receive US dollars. When you pay with Bitcoin, Ethereum, or any other cryptocurrency, it's instantly converted to USD at the current exchange rate. This means your payment is processed immediately and your order ships right away - no waiting for crypto confirmations."
        ]
      },
      {
        "question": "Is paying with crypto safe?",
        "answer": [
          "Yes! Crypto payments are processed securely through Stripe, the same trusted payment processor used by millions of businesses worldwide. Your wallet connects directly to Stripe - we never see or store your crypto wallet information."
        ]
      },
      {
        "question": "Will I get an email confirmation when I order merchandise?",
        "answer": [
          "Yes! When you order custom merchandise (like a mug or t-shirt with your family tree), you'll receive an email confirmation with your full order details including item, quantity, pricing breakdown, and shipping address. You'll also get a second email with tracking information once your order ships."
        ]
      },
      {
        "question": "Do I get order emails for gift registry items from Amazon, Etsy, etc.?",
        "answer": [
          "No — gift registry items from Amazon, Etsy, Giftlab, and other retailers are purchased directly through those stores. The retailer handles the entire purchase, so they'll send the buyer order confirmation and tracking emails directly. FamilyRoots only sends order emails for custom merchandise printed through our site."
        ]
      },
      {
        "question": "Which retailers are supported for gift registries?",
        "answer": [
          "You can add items from any online store by pasting the product URL. We have built-in quick-search buttons for Amazon, Etsy, Giftlab, Giftory, and Lucasgift — click a store button to search directly on their site, find the item, and copy the link back. These retailers also have affiliate tracking built in, which helps support FamilyRoots at no extra cost to you. Any other retailer URL works too — just paste the link and fill in the item details manually."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "FamilySearch is a free platform with over 66 billion historical records: birth certificates, marriage records, census data, immigration documents, military records, and more. FamilyRoots connects to FamilySearch so you can search those records and import ancestors directly into your family tree, all without leaving the app. Go to the ",
          {
            "text": "FamilySearch",
            "href": "/familysearch"
          },
      ...
      },
      {
        ...
        "answer": [
          ...
          " lets you look up individual historical records by name, birth year, birthplace, and other details. You get a list of matching records, and you can add any result directly into one of your trees.",
          {
            "tag": "br",
            "children": []
          },
          ...
          " pulls your entire FamilySearch family tree, organized by ancestors, descendants, and spouses. You can select multiple people at once, and all their relationships (parent-child, spouse) are imported automatically.",
          {
            "tag": "br",
            "children": []
          },
          ...
          "Use Search when you're looking for a specific person. Use Import Tree when you want to bring over a whole family branch with connections intact."
        ]
      },
      {
        "question": "When I search for a person, do I get all their family relationships too?",
        "answer": [
          "No. Search results are individual records, one person at a time, without relationships. This is because historical records (like a census entry or a birth certificate) are about a specific person, not a family tree. If you want to import a whole family branch with parent-child and spouse connections already set up, use the Tree Import feature instead. It pulls your FamilySearch family tree with all the relationships included."
        ]
      },
      {
        "question": "How do I import a person from search results into my tree?",
        "answer": [
          "When you find someone in the search results, click the \"Import to Tree\" button next to their name. A dialog will ask you to pick which of your trees to add them to. After importing, the person appears as a new member in your tree. You'll then need to open your tree and use \"Add Relationship\" to connect them to existing family members (as a parent, child, spouse, or sibling)."
        ]
      },
      {
        ...
        "answer": [
          "Go to the ",
          {
            "text": "FamilySearch page",
            "href": "/familysearch?tab=import"
          },
      ...
      },
      {
        ...
        "answer": [
          "Not currently. The FamilySearch integration is manual, meaning you search for people and choose what to import. There's no automatic monitoring that watches for new records matching your family. This is a feature we'd like to add in the future, but for now, you'll want to periodically search FamilySearch for new records as they become available."
        ]
      },
      {
        "question": "Do I need a FamilySearch account?",
        "answer": [
          "Yes, you need a free FamilySearch account to use the integration. FamilySearch is completely free and open to everyone. Once you have an account, you connect it to FamilyRoots on the Historical Records page by clicking the Connect button, which securely links the two accounts."
        ]
      },
      {
        "question": "Is my FamilySearch data shared with other FamilyRoots users?",
        "answer": [
          "No. Your FamilySearch connection is private to your account. Any records you search or ancestors you import are only visible within your own trees, subject to whatever sharing and collaboration permissions you've set. Other FamilyRoots users cannot see your FamilySearch data."
        ]
      }
    ]
  },
    ...
    "items": [
      {
        ...
        "answer": [
          "Memory Lane is a storytelling feed attached to your family tree where members can share memories, milestones, traditions, funny moments, and life lessons. Think of it as a private family journal that lives alongside your tree. Each memory can include a title, story text, photos, and a category so your family's most meaningful moments are preserved and easy to browse."
        ]
      },
      {
        "question": "How do I add a memory to Memory Lane?",
        "answer": [
          "Navigate to your tree, open the Memories tab, and tap the button to add a new memory. Give it a title, write the story, choose a category, optionally attach a photo, and save. The memory is immediately visible to everyone who has access to the tree."
        ]
      },
      {
        "question": "What categories are available for memories?",
        "answer": [
          "There are five categories to organize your memories: Memory (general recollections), Milestone (significant achievements or events), Tradition (recurring family customs), Funny (humorous stories and moments), and Lesson (wisdom or life lessons passed down). Categories make it easy to filter and browse specific types of stories."
        ]
      },
      {
        "question": "Can I add photos to memories?",
        "answer": [
          "Yes. Each memory supports a photo attachment. When creating or editing a memory, you can upload an image that accompanies the story. This is great for pairing a written memory with the photo that captures the moment."
        ]
      },
      {
        "question": "Who can see memories on Memory Lane?",
        "answer": [
          "Memories are visible to everyone who has access to the tree. Only tree members with edit permissions can add, edit, or delete memories. Visibility follows the same access rules as the rest of your tree — if someone can see the tree, they can see the memories."
        ]
      },
      {
        "question": "What are Voice Notes?",
        "answer": [
          "Voice Notes let you record audio messages attached to individual family member profiles. Capture a grandparent telling a story, a parent sharing advice, or a child's first words — all saved directly on the person's profile in the tree. Voice Notes require a Cultivator subscription or above."
        ]
      },
      {
        "question": "How do I record a Voice Note?",
        "answer": [
          "Open any family member's detail panel by clicking on them in the tree. Scroll to the Voice Notes section and tap the record button. Grant microphone access when prompted, record your message (up to 5 minutes), and save it. The recording is attached to that member's profile and can be played back by anyone with access to the tree. Voice notes are limited to 25MB per file."
        ]
      },
      {
        "question": "Where do Voice Notes appear?",
        "answer": [
          "Voice Notes appear in the member detail panel when you click on a family member in the tree view. They are listed in the Voice Notes section alongside other profile information like location, relationships, and life events."
        ]
      },
      {
        "question": "Can I delete a Voice Note?",
        "answer": [
          "Yes. If you have edit permissions on the tree, you can delete any Voice Note from a member's profile. Open the member's detail panel, find the Voice Note you want to remove, and use the delete option. Deleted Voice Notes cannot be recovered."
        ]
      },
      {
        "question": "Are there file size limits for uploads?",
        "answer": [
          "Yes. Photos are limited to 10MB per file. Voice notes (audio) are limited to 25MB and 5 minutes of recording. Video attachments are limited to 100MB per file. These limits help keep the platform fast and reliable for everyone."
        ]
      },
      {
        "question": "Do Voice Notes and video attachments require a subscription?",
        "answer": [
          "Yes. Voice notes and video attachments require a Cultivator subscription ($4.99/month) or above. Free Explorer users can still upload photos, but voice and video features are reserved for paid subscribers. Monthly limits vary by tier: Cultivator gets 20/month, Heritage gets 80/month, and Legacy gets 200/month. See our ",
          {
            "text": "Pricing page",
            "href": "/pricing"
          },
      ...
      },
      {
        ...
        "answer": [
          "The Annual Tree Report is a yearly summary of your family tree's growth and activity. It shows statistics like total members, new additions, relationship breakdowns, and other insights about how your tree has evolved over the year. It's a great way to reflect on your family's growth and share highlights with relatives."
        ]
      },
      {
        "question": "Can I view Annual Tree Reports from past years?",
        "answer": [
          "Yes. The Annual Tree Report section lets you select different years to review past reports. This allows you to compare growth across years and see how your family tree has expanded over time."
        ]
      },
      {
    ...
    "items": [
      {
        ...
        "answer": [
          "Member Radar is a proximity discovery feature that lets you find other FamilyRoots members nearby — like scanning for WiFi, but for people. Only signed-in members can use it. Turn it on when you're at a family reunion, community event, or anywhere you want to connect with other members in person."
        ]
      },
      {
        "question": "Is my location shared all the time?",
        "answer": [
          "No. Radar is completely opt-in. Your location is only shared while you have Radar turned on. It automatically expires after 5 minutes of inactivity. You can turn it off anytime with one tap. When Radar is off, no location data is collected or shared."
        ]
      },
      {
        "question": "What's the difference between Broadcast and Watch mode?",
        "answer": [
          "Broadcast mode makes you visible to other nearby members and lets you see them too — great for meetups and reunions. Watch mode lets you scan for nearby members without revealing your own position. Think of it as listening on the channel without transmitting."
        ]
      },
      {
        "question": "How far can Member Radar scan?",
        "answer": [
          "You can set the scan radius from 1 mile up to 50 miles. The default is 5 miles. For events and reunions, a smaller radius like 1-2 miles works well. For discovering members in your broader area, try 10-25 miles."
        ]
      },
      {
        "question": "Can non-members see me on Radar?",
        "answer": [
          "No. Member Radar is a members-only feature. Only signed-in FamilyRoots users with Radar active can see other members. It's a private channel — if you're not on the network, you can't see anyone."
        ]
      }
    ]
  }
...
function faqAnswerPartText(part: FAQAnswerPart): string {
  if (typeof part === "string") return part;
  if ("text" in part) return part.text;
  if (part.tag === "br") return "\n";

  const text = part.children.map(faqAnswerPartText).join("");
  return part.tag === "ul" || part.tag === "li" || part.tag === "p"
    ? "\n" + text + "\n"
    : text;
}
