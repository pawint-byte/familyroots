...
export default function ImportConflictResolution({
  ...
  const [importSummary, setImportSummary] = useState<{
    integrity: {
      ...
      chainIntact: boolean;
      transferredData: { events: number; nameHistory: number; education: number; career: number; tags: number; fsSources: number; extIds: number; specialConns: number; giftRegistries: number; voiceNotes: number; memories: number; invitations: number; claimRequests: number; custodianshipReqs: number; mutes: number };
            ...
            {Object.values(importSummary.integrity.transferredData).some(v => v > 0) && (
              <div className="pt-2 border-t" data-testid="section-transferred-data">
                ...
                <div className="flex flex-wrap gap-1.5">
                  ...
                  {importSummary.integrity.transferredData.memories > 0 && <Badge variant="secondary" className="text-xs">{importSummary.integrity.transferredData.memories} memories</Badge>}
