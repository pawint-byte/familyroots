          ...
          <TabsContent value="tree" className="flex-1 m-0 relative overflow-hidden">
            {isLoading || (showMergedView && isMergedLoading) ? (
              ...
              <>
                ...
                <div 
                  className="absolute bottom-20 sm:bottom-4 right-2 sm:right-4 z-20 bg-background/90 backdrop-blur rounded-lg p-1.5 sm:p-2 shadow-lg border"
                  role="group"
                ...
                <div className="absolute bottom-20 sm:bottom-4 left-2 sm:left-4 flex flex-row gap-1 sm:gap-2 z-20 bg-background/90 backdrop-blur rounded-lg p-1.5 sm:p-2 shadow-lg border">
                  <Button 
                    variant="secondary" 
                    size="icon" 
