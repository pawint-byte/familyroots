...
const translations: Record<Language, TranslationKeys> = {
  en: {
    ...
    landing: {
      heroTagline: "Your Private Network, Real Connections",
      heroTitle: "Where Every Connection",
      heroTitleHighlight: "Actually Means Something",
      heroDescription: "Build private, members-only networks for your family, church, team, or any group that matters. Unlike social media where anyone can see your connections, FamilyRoots keeps your circles private and every relationship labeled with real meaning.",
      startTree: "Build Your Private Network",
      watchDemo: "See How It Works",
      featuresTitle: "Built for Real Relationships",
      featuresSubtitle: "Everything you need to organize, protect, and grow the connections that matter most",
      ...
      feature4Title: "Members-Only Privacy",
      feature4Desc: "Three tiers of visibility, invitation-only access, and role-based permissions. Your network is truly private - only members see who's connected and how",
      ...
      ctaTitle: "Ready to Build Your Private Network?",
      ctaDescription: "Whether it's your family, your church, your team, or your closest friends - create a space where every connection is real, every role is clear, and only your members can see inside. One group at a time, build your own private network.",
      ...
      headsOfHouseholdCta: "Leaders & Organizers: Build Your Network",
      headsOfHouseholdDesc: "Whether you're a family matriarch, a church pastor, a team captain, or a chapter president - start with the people you know. Every private network starts with one connection.",
    ...
    pricing: {
      ...
      premiumTier: "$4.99/month",
      currentPlan: "Current Plan",
      upgrade: "Upgrade to Cultivator",
      features: {
        trees: "1 Family Tree",
  ...
  es: {
    ...
    pricing: {
      ...
      premiumTier: "$4.99/mes",
      currentPlan: "Plan Actual",
      upgrade: "Actualizar a Cultivator",
      features: {
  ...
  fr: {
    ...
    pricing: {
      ...
      premiumTier: "$4.99/mois",
      currentPlan: "Plan Actuel",
      upgrade: "Passer à Cultivator",
      features: {
  ...
  de: {
    ...
    pricing: {
      ...
      premiumTier: "$4.99/Monat",
      currentPlan: "Aktueller Plan",
      upgrade: "Auf Cultivator upgraden",
      features: {
        trees: "1 Stammbaum",
